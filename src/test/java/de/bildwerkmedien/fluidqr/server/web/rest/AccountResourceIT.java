...
import static de.bildwerkmedien.fluidqr.server.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import de.bildwerkmedien.fluidqr.server.repository.AuthorityRepository;
...
import de.bildwerkmedien.fluidqr.server.service.dto.PasswordChangeDTO;
import de.bildwerkmedien.fluidqr.server.service.dto.UserDTO;
import de.bildwerkmedien.fluidqr.server.web.rest.vm.KeyAndPasswordVM;
import de.bildwerkmedien.fluidqr.server.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    @Transactional
    @WithAnonymousUser()
    void testRegisterValidWithAnonymousUser() throws Exception {
        ManagedUserVM validUser = new ManagedUserVM();
        validUser.setLogin("test-register-valid");
        validUser.setPassword("password");
        validUser.setFirstName("Alice");
