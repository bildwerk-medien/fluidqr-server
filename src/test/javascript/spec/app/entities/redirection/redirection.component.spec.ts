...
import { RedirectionComponent } from 'app/entities/redirection/redirection.component';
...
describe('Component Tests', () => {
  describe('Redirection Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.redirections && comp.redirections[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
