...
describe('account', () => {
  ...
  it('should login successfully with admin account', async () => {
    ...
    const expect2 = 'global.menu.qr-codes';
    const value2 = await element(by.id('qr-codes-nav-element')).element(by.css('span')).getAttribute('jhiTranslate');
    expect(value2).to.eq(expect2);
  });
