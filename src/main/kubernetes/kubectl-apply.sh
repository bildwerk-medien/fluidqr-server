...
logSummary() {
    echo ""
        ...
        echo "JHipster Grafana - http://jhipster-grafana.fluidqr.fluidqr.example.com"
        echo "FluidQrServer - http://fluidqrserver.fluidqr.fluidqr.example.com"
        echo "#####################################################"
}
...
default() {
    ...
    kubectl apply -f fluidqrserver-${suffix}/
