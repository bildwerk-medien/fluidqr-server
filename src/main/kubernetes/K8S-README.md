...
```
$ kubectl get svc fluidqrserver -n fluidqr
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n fluidqr
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n fluidqr
```
...
```
$ kubectl get svc jhipster-prometheus -n fluidqr
```
...
```
$ kubectl get svc jhipster-grafana -n fluidqr
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n fluidqr
```

and explore the details using

```
$ kubectl get svc exposed-registry -n fluidqr
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n fluidqr
```
