...
/**
 * REST controller for managing {@link QrCode}.
 */
@RestController
@RequestMapping("/api")
public class QrCodeResource {
    ...
    public QrCodeResource(@Qualifier("qrCodeServiceExtendedImpl") QrCodeService qrCodeService, QrCodeQueryExtendedService qrCodeQueryService) {
