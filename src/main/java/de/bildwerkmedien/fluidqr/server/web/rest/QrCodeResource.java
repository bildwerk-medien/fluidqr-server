...
public class QrCodeResource {
    ...
    public QrCodeResource(
        @Qualifier("qrCodeServiceExtendedImpl") QrCodeService qrCodeService,
        QrCodeQueryExtendedService qrCodeQueryService,
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/qr-codes/{id}", consumes = { "application/json", "application/merge-patch+json" })
