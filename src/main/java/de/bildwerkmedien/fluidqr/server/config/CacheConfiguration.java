...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("FluidQrServer");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("FluidQrServer");
        ...
        config.getMapConfigs().put("de.bildwerkmedien.fluidqr.server.domain.*", initializeDomainMapConfig(jHipsterProperties));
